...
public static class SettingsSeedData
{
    ...
    private static List<SiteSetting> GetAllSettings() => new()
    {
        ...
        new() { Key = "subscription.currency",        Group = "Billing", Label = "Subscription currency",            Type = "text",    Value = "NGN",                                          Description = "Paystack currency for subscription charges (e.g. NGN, USD, GHS).", SortOrder = 8 },
        new() { Key = "subscription.price_monthly",   Group = "Billing", Label = "Price per store / month",          Type = "number",  Value = "80000",                                        Description = "Amount charged per active store, per month, in the currency above (default ≈ $50 in NGN — adjust on the Subscribe page).", SortOrder = 9 },
        new() { Key = "subscription.price_yearly",    Group = "Billing", Label = "Price per store / year",           Type = "number",  Value = "800000",                                       Description = "Amount charged per active store, per year, in the currency above (default ≈ $500 in NGN — adjust on the Subscribe page).", SortOrder = 10 },
