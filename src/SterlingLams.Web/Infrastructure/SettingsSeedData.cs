...
public static class SettingsSeedData
{
    ...
    private static List<SiteSetting> GetAllSettings() => new()
    {
        ...
        new() { Key = "shipping.sameday_start",     Group = "Shipping", Label = "Same-day — available from (HH:mm)", Type = "text",    Value = "01:00", Description = "Start of the daily window (24-hour, Nigeria time) when customers can select same-day. Default 01:00 (1 AM).", SortOrder = 11 },
        new() { Key = "shipping.sameday_end",       Group = "Shipping", Label = "Same-day — available until (HH:mm)", Type = "text",   Value = "13:00", Description = "End of the daily window (24-hour, Nigeria time). Default 13:00 (1 PM). Outside these hours the option is shown greyed-out.", SortOrder = 12 },
