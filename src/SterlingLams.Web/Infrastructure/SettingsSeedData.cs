...
public static class SettingsSeedData
{
    ...
    private static List<SiteSetting> GetAllSettings() => new()
    {
        ...
        new() { Key = "homepage.hero_fit",         Group = "Homepage", Label = "Hero Image Sizing",      Type = "select",  Value = "fill",                                                 Description = "How campaign banners are sized: Fill crops the image to cover the hero; Fit shows the whole image so nothing is cut off (with a light background around it).", SortOrder = 5 },
