...
public static class AdminSections
{
    ...
    public static readonly List<AdminSection> Nav = new()
    {
        ...
        new("DataReset",  "Reset test data", "DataReset", "M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15", "Settings", OwnerOnly: true),
    ...
    /// <summary>Heroicon path for each collapsible group heading, so the sidebar groups carry an icon
    /// like the standalone Overview and Finance sections. Keyed by the group name in <see cref="GroupOrder"/>.</summary>
    public static readonly Dictionary<string, string> GroupIcons = new()
    {
        ["Sales"]     = "M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z",
        ["Catalogue"] = "M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4",
